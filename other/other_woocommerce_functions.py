...
def main():
    ...
    # print("\nExample 2: Get Product by SKU")
    # sku = "PROD-001"  # Replace with actual SKU
    # product = wc_api.get_product_by_sku(sku)
    # if product:
    #     wc_api.print_product_info(product)
    
    # # Example 3: Get all products (paginated)
    # print("\nExample 3: Get All Products")
    # products = wc_api.get_all_products(per_page=5, page=1)
    # for product in products:
    #     print(f"- {product['name']} (ID: {product['id']}, Price: ${product['price']})")
    
    # # Example 4: Search products
    # print("\nExample 4: Search Products")
    # search_results = wc_api.search_products("shirt", per_page=5)
    # for product in search_results:
    #     print(f"- {product['name']} (ID: {product['id']}, SKU: {product['sku']})")
    
    # # Example 5: Save product data to JSON file
    # print("\nExample 5: Save Product to JSON")
    # product = wc_api.get_product_by_id(product_id)
    # if product:
